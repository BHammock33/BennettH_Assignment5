...
public interface CustomList<T> {
	...
	boolean add (T item);
	/** 
	 * This method should add a new item into the <code>CustomList</code> at the specified index (thus shuffling the other items to the right). If the index doesn't yet exist,
	 * then you should throw an <code>IndexOutOfBoundsException</code>.
	 *  @param index teh spot in the zero-based array where you'd like to insert your new item
	 ...
	 * specified index. This will NOT leave an empty <code>null</code>where the item was removed,
	 * instead all other items to the right will be shuffled to the left.
